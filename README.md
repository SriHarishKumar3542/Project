...
HealthBridge is a web-based social-benefit platform designed to make healthcare-support information easier to discover and understand.
...
HealthBridge addresses this problem by providing a centralized platform where users can:
...
HealthBridge is designed as an information and guidance platform. It does **not** provide official government eligibility decisions or medical diagnosis.

---

## 🎯 Objectives

The main objectives of HealthBridge are:
...
HealthBridge consists of five major user-facing modules.
...
The Eligibility Checker is one of the core modules of HealthBridge.
